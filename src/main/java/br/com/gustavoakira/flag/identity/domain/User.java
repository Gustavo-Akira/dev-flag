...
public final class User {
  ...
  public static User create(
      UserId id, String name, Email email, String passwordHash, LocalDateTime createdAt) {
    return new User(id, name, email, passwordHash, UserStatus.ACTIVE, createdAt, null);
  }
  ...
  public static User reconstitute(
      ...
      LocalDateTime createdAt,
      LocalDateTime updatedAt) {
    return new User(id, name, email, passwordHash, status, createdAt, updatedAt);
  }
