...
class EmailTest {
  ...
  void shouldThrowWhenEmailIsNull() {
    DomainRuleException exception = assertThrows(DomainRuleException.class, () -> new Email(null));
  ...
  void shouldThrowWhenEmailIsBlank() {
    DomainRuleException exception =
        assertThrows(DomainRuleException.class, () -> new Email("     "));
  ...
  void shouldThrowWhenEmailHasInvalidFormat() {
    DomainRuleException exception =
        assertThrows(DomainRuleException.class, () -> new Email("gustavo-email.com"));
  ...
  void shouldThrowWhenEmailDoesNotContainDomain() {
    assertThrows(DomainRuleException.class, () -> new Email("gustavo@"));
  }

  @Test
  void shouldThrowWhenEmailDoesNotContainUser() {
    assertThrows(DomainRuleException.class, () -> new Email("@email.com"));
  }
