...
class UserTest {
  ...
  void shouldCreateUser() {
    ...
    User user =
        User.create(id, "Gustavo", new Email("gustavo@email.com"), "hashed-password", createdAt);
  ...
  void shouldThrowWhenChangingNameToBlank() {
    ...
    DomainRuleException exception =
        assertThrows(DomainRuleException.class, () -> user.changeName("", LocalDateTime.now()));
  ...
  void shouldThrowWhenChangingPasswordToBlank() {
    ...
    DomainRuleException exception =
        assertThrows(DomainRuleException.class, () -> user.changePassword("", LocalDateTime.now()));
  ...
  void shouldThrowWhenTouchingWithNullDate() {
    ...
    DomainRuleException exception =
        assertThrows(DomainRuleException.class, () -> user.changeName("Akira", null));
